...
#define ME_EN1_Pin GPIO_PIN_10
#define ME_EN1_GPIO_Port GPIOB
#define RE_2B_Pin GPIO_PIN_6
#define RE_2B_GPIO_Port GPIOC
#define RE_2A_Pin GPIO_PIN_7
#define RE_2A_GPIO_Port GPIOC
#define MPWM_1_Pin GPIO_PIN_8
#define MPWM_1_GPIO_Port GPIOA
#define MPWM_2_Pin GPIO_PIN_9
#define MPWM_2_GPIO_Port GPIOA
#define MPWM_3_Pin GPIO_PIN_10
#define MPWM_3_GPIO_Port GPIOA
#define MPWM_4_Pin GPIO_PIN_11
#define MPWM_4_GPIO_Port GPIOA
